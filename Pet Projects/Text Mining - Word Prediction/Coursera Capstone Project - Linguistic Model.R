...
# Splitting the words in quads for a later word by word match with the user input 
...
## DONT USE BELOW PREDICTION MODEL 
## Prediction Version 1.0 (Usual grep funcion -- Lower Accuracy)
